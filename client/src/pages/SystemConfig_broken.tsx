...
function SystemConfig() {
  ...
  const [selectedDataType, setSelectedDataType] = useState('employees'); // Changed from activeImportTab
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex flex-col items-center space-y-4">
                  ...
                  <Select value={selectedDataType} onValueChange={setSelectedDataType}>
                    <SelectTrigger className="w-full max-w-md">
                      <SelectValue placeholder={language === 'English' ? 'Choose data type...' : 'اختر نوع البيانات...'} />
                    </SelectTrigger>
                    <SelectContent>
                ...
                <div className="border-2 border-dashed border-gray-200 rounded-lg p-6">
                  <h3 className="text-lg font-semibold text-center mb-4 text-gray-700">
                    {language === 'English' ? 'Available Actions' : 'الإجراءات المتاحة'}
                  </h3>
                  <div className="grid md:grid-cols-3 gap-4">
                    {/* Import Card */}
                    <Card className="cursor-pointer hover:shadow-md transition-shadow border-blue-200 hover:border-blue-400">
                      <CardContent className="p-4 text-center">
                        ...
                        <p className="text-xs text-blue-600">
                          {language === 'English' ? 'Upload CSV files' : 'رفع ملفات CSV'}
                        </p>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="cursor-pointer hover:shadow-md transition-shadow border-green-200 hover:border-green-400">
                      <CardContent className="p-4 text-center">
                        ...
                        <p className="text-xs text-green-600">
                          {language === 'English' ? 'Download CSV files' : 'تنزيل ملفات CSV'}
                        </p>
                      </CardContent>
                    </Card>

                    {/* Template Card */}
                    <Card className="cursor-pointer hover:shadow-md transition-shadow border-purple-200 hover:border-purple-400">
                      <CardContent className="p-4 text-center">
                        <FileDown className="h-8 w-8 text-purple-600 mx-auto mb-2" />
                        <h4 className="font-medium text-purple-800 mb-1">
                          {language === 'English' ? 'Download Template' : 'تنزيل القالب'}
                        </h4>
                        <p className="text-xs text-purple-600">
                          {language === 'English' ? 'Get CSV template' : 'احصل على قالب CSV'}
                        </p>
                      </CardContent>
                    </Card>
                  </div>
