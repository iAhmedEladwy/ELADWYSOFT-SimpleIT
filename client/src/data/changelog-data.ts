...
export const CHANGELOG_DATA: ChangelogEntry[] = [
  {
    ...
    changes: {
      features: [
        ...
        "   • Priority Levels - 5 levels (info, low, medium, high, critical) for smart filtering",
        "   • Categories - 7 categories (assignments, status_changes, maintenance, approvals, announcements, reminders, alerts)",
        "   • Custom Templates - Admin-configurable templates with variable substitution {{placeholder}}",
        "   • Smart Batching - Automatic grouping of similar notifications with bilingual summaries",
        "   • Snooze Feature - Postpone notifications to a specific time",
        "   • Do Not Disturb - Configure quiet hours by day/time with timezone support",
        "   • Notification Versioning - Schema versioning for future compatibility",
        "   • readAt Tracking - Precise timestamp when notifications are marked as read",
        "🔧 Notification Management:",
        "   • Template CRUD API - 7 endpoints for creating/managing notification templates",
        "   • Automated Cleanup - Daily cron job (2 AM) removes read notifications older than 30 days",
        "   • Snooze Processing - Every 5 minutes checks and reactivates snoozed notifications",
        "   • Auto-batching - Runs every 5 minutes to group similar notifications",
        "📊 Database Enhancements:",
        "   • 8 performance indexes for notification queries (composite, partial, covering)",
        "   • 2 new enums (notification_priority, notification_category)",
        "   • notification_templates table with variable validation",
        "   • password_reset_attempts table for rate limiting (5 attempts/hour, 30-min block)",
      ...
      improvements: [
        ...
        "🔐 DND Backend Enforcement - Server-side validation with timezone and overnight range support",
        "🌍 Bilingual Batching - Smart notification summaries in English and Arabic",
        "📈 Priority/Category Integration - All 12 notification functions now set appropriate priority/category",
      ...
      bugfixes: [
        ...
        "🔧 Fixed readAt timestamp now properly tracked on mark-read action",
      ]
    }
  },
  {
