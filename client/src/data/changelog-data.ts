...
export const CHANGELOG_DATA: ChangelogEntry[] = [
  {
    version: "0.4.7",
    date: "2025-11-11",
    title: "Complete In-App Notification System & Route Modularization",
    type: "minor",
    changes: {
      features: [
      ...
      improvements: [
        ...
        "🏗️ Route Modularization - Extracted 628 lines into focused modules:",
        "   • server/routes/backup.ts (368 lines) - All backup/restore operations",
        "   • server/routes/systemHealth.ts (32 lines) - System monitoring endpoints",
        "   • server/routes/notifications.ts (228 lines) - Notification API",
        "📉 Code Cleanup - Reduced main routes.ts from 8,444 → 7,798 lines (-7.7%)",
