...
export const CHANGELOG_DATA: ChangelogEntry[] = [
  {
    ...
    changes: {
      features: [
        "🎯 Employee Portal - Complete self-service portal for employees",
        "   • Dedicated employee portal with role-based access",
        "   • Dashboard with asset and ticket statistics",
        "   • My Assets page with detailed asset history",
        "   • My Tickets page with advanced filtering and search",
        "   • Create Ticket form with category selection",
        "   • Profile management with contact info and password change",
        "   • Separate navigation and branding for portal",
        "📦 Asset History Tracking",
        "   • View assignment history for each asset",
        "   • Track maintenance records and related tickets",
        ...
        "👤 Profile Management",
        "   • Edit contact information (personal email, mobile)",
        "   • Change password with validation",
        "   • View employee details and department information",
        "📊 Portal Dashboard",
        "   • Asset statistics (total assigned, by status)",
      ...
      improvements: [
        "🎨 UI/UX Enhancements:",
        "   • Consistent footer positioning across all portal pages",
        "   • Responsive layout optimized for mobile and desktop",
        "   • Bilingual support (English/Arabic) throughout portal",
        "   • Clean, modern interface with ELADWYSOFT branding",
        "⚙️ Version Management:",
        "   • Centralized version system (shared/version.ts)",
        "   • Version displayed in login, setup, header, and portal footer",
        "   • Easy single-file version updates across entire application",
        "   • Semantic versioning (MAJOR.MINOR.PATCH)",
        "🔧 Portal Backend:",
        "   • Dedicated portal API routes (/api/portal/*)",
        "   • Employee-only access with RBAC enforcement",
        "   • Optimized queries for employee-specific data",
        "   • Categories endpoint with auto-creation of defaults",
