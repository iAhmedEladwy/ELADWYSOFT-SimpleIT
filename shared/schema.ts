...
export const insertEmployeeSchema = createInsertSchema(employees).omit({ 
  id: true, 
  empId: true,  // Auto-generated by database
  createdAt: true, 
  updatedAt: true,
  name: true,   // Generated column
  email: true,  // Generated column
  phone: true,  // Generated column
  position: true // Generated column
});
export const insertAssetSchema = createInsertSchema(assets)
  .omit({ 
    id: true, 
    assetId: true,  // Auto-generated by database
    createdAt: true, 
    updatedAt: true 
  })
  .extend({
