...
- **Converted to Dynamic Asset Types**: Replaced hardcoded asset type ENUMs with flexible varchar fields that use dynamic types from system configuration. Updated import processing, demo data creation, and database schema to support unlimited custom asset types while maintaining backward compatibility.
